import {
  AppointmentSlot as AppointmentSlotType,
  isSameSlot,
...
export default function AppointmentSlot({
  ...
  selectedSlots: AppointmentSlotType[];
  onChange: any;
}) {
  ...
  colorStyle = isSelected
    ...
    : "border-gray-500 text-gray-500 bg-gray-50 hover:border-gray-400 group";

  return (
    <div>
      <label
        className={`flex flex-row place-content-between gap-4 px-3 py-1 border-solid border-2 rounded ${colorStyle}`}
        htmlFor={id}
      >
        <span>
          {slot.start.toLocaleDateString("fr-FR", {
