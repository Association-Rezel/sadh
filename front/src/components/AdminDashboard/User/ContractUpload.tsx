...
export default function ContractUpload({ keycloak_id }: { keycloak_id: string }) {
    ...
    useEffect(() => {
        ...
        Api.fetchFile("/users/"+keycloak_id+"/contract").then(file => {
    ...
    const handleSubmit = (event) => {
        ...
        Api.uploadFile("/users/"+keycloak_id+"/contract", data)
        .catch(error => {
