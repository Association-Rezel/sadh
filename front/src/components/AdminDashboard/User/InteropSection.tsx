        ...
        <div>
          <div className="mt-5">
            ...
            <TextField
              ...
              size="small"
              fullWidth
              {...registerToMembershipUpdateForm("ref_commande")}
            />
          </div>
          <div className="mt-5">
            ...
            <TextField
              ...
              size="small"
              fullWidth
              {...registerToMembershipUpdateForm("ref_prestation")}
            />
          </div>
          <div className="mt-5">
            <Button
              variant="contained"
              onClick={() => setCmdAccesDialogOpen(true)}
            >
              Générer CMD_ACCES
            </Button>
          </div>
          <div className="mt-5">
            <Button
              variant="contained"
              onClick={() => setCRMESDialogOpen(true)}
            >
              Générer CR_MES
            </Button>
          </div>
          <div className="mt-5">
            <Button
              variant="contained"
              onClick={() => setAnnulAccesDialogOpen(true)}
            >
              Générer ANNUL_ACCES
            </Button>
          </div>
          <div className="flex items-center mt-5">
            <input
              type="checkbox"
              {...registerToMembershipUpdateForm("cmd_acces_sent")}
            />
          ...
          <div className="flex items-center mt-5">
            <input
              type="checkbox"
              {...registerToMembershipUpdateForm("cr_mes_sent")}
            />
          ...
          <div className="flex items-center mt-5">
            <input
              type="checkbox"
              {...registerToMembershipUpdateForm("annul_acces_sent")}
            />
