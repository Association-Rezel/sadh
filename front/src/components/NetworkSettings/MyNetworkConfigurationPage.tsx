  ...
  return (
    <Stack direction={"column"} spacing={2}>
      ...
      >
        ...
        >
          <h3>
            Modifier le SSID <SSIDHelper />
          </h3>

          <SsidResetForm unet={unet} setUnet={setUnet} />
        </Stack>
        <Stack
          direction={"column"}
          spacing={{ xs: 1, sm: 2, md: 2 }}
...
function BoxInfos({ unet }) {
  const [stateCopy, setStateCopy] = React.useState<string>(
    "Copier le mot de passe",
  );
  const [stateIcon, setStateIcon] = React.useState<React.ReactNode>(
    <ContentCopyIcon />,
  );
...
function FirewallInfos({ unet, setUnet }) {
  ...
  return (
    <div style={{ textAlign: "left", width: "60%" }}>
      ...
      <br />
      <p>
        <i>Toute modification sera effective à 6h du matin</i>
      </p>
      <br />
      <div>
        <div>
...
function DNSServers({ unet, setUnet }) {
  ...
  return (
    <div style={{ textAlign: "left", width: "60%" }}>
      ...
      <p>
        <i>
          Serveurs DNS distribués à vos appareils par le serveur DHCP de la box.
        </i>
      </p>
      <br />
      <p>
      ...
      <div>
        <div>
          ...
          <p>
            <i>DNS par défaut : 8.8.8.8 et 1.1.1.1</i>
          </p>
        ...
        <div>
          ...
          <p>
            <i>DNS par défaut : 2001:4860:4860::8888 et 2606:4700:4700::1111</i>
          </p>
