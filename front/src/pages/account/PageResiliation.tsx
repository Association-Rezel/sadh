...
export default function PageResiliation() {
  ...
  const handleMailto = () => {
    ...
    const formattedDate = resiliationDate
      ? dayjs(resiliationDate).format("DD/MM/YYYY")
      : "[Date de résiliation]";
          ...
          <Grid item xs={12} md={7}>
            <Paper sx={{ p: 3, height: "100%" }}>
              ...
              <Typography variant="body2" color="text.secondary" paragraph>
                C'est la méthode la plus simple. Sélectionnez la date de fin
                souhaitée pour préparer automatiquement votre email.
              </Typography>
            ...
            >
              ...
              <List>
                ...
                >
                  ...
                  <ListItemText
                    primary={
                      <Typography fontWeight="bold">Mois entamé</Typography>
                    }
