        ...
        <div className="flex flex-col items-start">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <label className="block text-left text-sm text-gray-500">
                ⚠ Numéro utilisé pour vous contacter et réaliser l'installation
              </label>
              <Controller
                name="phone_number"
                control={control}
          ...
          <div className="flex flex-col items-start gap-2 mt-4">
            ...
            <Typography variant="body2" color="text.secondary" align="left">
              Cet IBAN nous servira à effectuer des remboursements partiels en
              cas de partage de votre lien fibre <br />
              (voir contrat et réglement intérieur à l'étape suivante), et pour
              rembourser votre caution à la fin de votre abonnement.
            </Typography>
          </div>
          ...
          <div className="mt-8">
            ...
            <ul className={"flex flex-col text-left gap-4 pl-4 mt-6"}>
              ...
              <li>
                ...
                <Typography variant="body2" color="text.secondary" align="left">
                  Vous devez régler votre cotisation pour un an (sauf si vous
                  êtes déjà membre). Être membre adhérent de Rezel est
                  obligatoire pour bénéficier du service FAI. Votre adhésion
                  commencera le jour de la signature de votre contrat. Elle est
                  à renouveler chaque année à la date anniversaire de votre
                  adhésion.
                </Typography>
              </li>
