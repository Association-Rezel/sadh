      ...
      {!user.membership.appointment && (
        <>
          <Typography variant="body1" align="center">
            Ton rendez-vous pour le raccordement à la fibre n'a pas encore été
            validé. Tu as indiqué les disponibilités suivantes :
          </Typography>
          ...
          <Typography variant="body1" align="center">
            Si tu souhaites modifier tes disponibilités, merci d'envoyer un mail
            au plus vite à fai@rezel.net
          </Typography>
          {!user.phone_number.startsWith("+33") &&
            !user.phone_number_verified && (
              <Typography variant="body1" align="center" color="error">
                Attention : ton numéro de téléphone n'est pas un numéro
                français. Merci de contacter fai@rezel.net pour le faire
                valider.
              </Typography>
            )}
        </>
...
export function ValidatedAppointment({
  appointment,
}: {
  ...
  return (
    <div className="mt-12 max-w-md">
      <Typography variant="body1" align="center">
        ...
        &nbsp;à{" "}
        <b>
          {appointment.slot.end.toLocaleTimeString("fr-FR", {
            hour: "2-digit",
            minute: "2-digit",
          })}
        </b>
      ...
      <Typography variant="body1" align="justify">
        Un technicien se présentera à ton domicile sur ce créneau pour effectuer
        le raccordement. Le rendez-vous peut durer jusqu'à 1 heure au delà du
