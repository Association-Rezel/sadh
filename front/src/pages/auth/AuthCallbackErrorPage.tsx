...
export default function AuthCallbackErrorPage() {
  ...
  const displayMessage =
    errorMessage ||
    "An unknown error occurred during the authentication process. Please try logging in again or contact support.";
    ...
    <>
      ...
      <div className="container mx-auto mt-8">
        <div className="flex flex-col items-center">
          <h1 className="text-2xl font-bold mb-4">Authentication Problem</h1>
