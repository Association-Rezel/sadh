...
import { Download, Euro, School, MoneyOff } from "@mui/icons-material";
                ...
                <List component="nav">
                    ...
                    <Link to={"overdue"}>
                        <ListItemButton>
                            ...
                            <ListItemText primary="Impayés" />
                        </ListItemButton>
                    </Link>
                    <Link to={"scholarship-student"}>
                        <ListItemButton>
                            <ListItemIcon>
                                <School />
                            </ListItemIcon>
                            <ListItemText primary="Etudiants Boursiers" />
                        </ListItemButton>
                    </Link>
                    <Link to={"ptah-images"}>
                        <ListItemButton>
