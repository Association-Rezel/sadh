...
./kcadm.sh create clients -r users -s clientId=back -s standardFlowEnabled=true -s publicClient=false -s clientAuthenticatorType=client-secret -s secret=d0b8122f-8dfb-46b7-b68a-f5cc4e25d000 -s directAccessGrantsEnabled=true
EOS'
